    ...
    return (
      <div className="h-full w-full">
        <div className="flex flex-col py-10 px-10 m-2 justify-center border-sky-700 border-[4px] items-center">
            <h1 className="flex mt-0 mb-10 border justify-center border-black bg-sky-300 shadow-2xl shadow-slate-800 p-4 font-extrabold text-7xl">Your Page count is {count}</h1>
            <div className="flex mt-20 mb-64 border gap-5 flex-row justify-center">
